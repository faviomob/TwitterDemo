...
@interface NSManagedObject (SWIFT_EXTENSION(Groot))
@end


@interface NSManagedObjectContext (SWIFT_EXTENSION(Groot))
@end


@interface NSValueTransformer (SWIFT_EXTENSION(Groot))
/**
...
*/
+ (void)setDictionaryTransformerWithName:(NSString * _Nonnull)name transform:(NSDictionary<NSString *, id> * _Nullable (^ _Nonnull)(NSDictionary<NSString *, id> * _Nonnull))transform;
/**
...
*/
+ (void)setEntityMapperWithName:(NSString * _Nonnull)name map:(NSString * _Nullable (^ _Nonnull)(NSDictionary<NSString *, id> * _Nonnull))map;
@end
